...
"}")
        ...
        self.src_img_button = QPushButton(self.MenuBox)
        self.src_img_button.setObjectName(u"src_img_button")
        self.src_img_button.setMinimumSize(QSize(0, 45))
        self.src_img_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.src_img_button.setStyleSheet(u"QPushButton{\n"
"background-image: url(:/all/img/img.png);\n"
"background-repeat: no-repeat;\n"
"background-position: left center;\n"
"border: none;\n"
"border-left: 23px solid transparent;\n"
...
"background-color: rgba(114, 129, 214, 59);\n"
"}")
        self.src_img_button.setIconSize(QSize(16, 16))

        self.verticalLayout_5.addWidget(self.src_img_button)
...
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 rgb(120, 205, 200),  stop:1 rgb(5, 150, 229));\n"
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.src_img_button.setText(QCoreApplication.translate("MainWindow", u"Img/Video", None))
